...
const courses: Course[] = [
  ...
  },
  {
    ...
    subCourses: [
      ...
      { title: "HYBRID SERVER PRO I:CORE", description: "Hybrid Server Pro: Core is a high-quality, easy-to-use curriculum where you will gain the knowledge and skills you need to configure and manage both on-premise and cloud based servers. Hosted on the online TestOut learning platform, LabSim, it provides a comprehensive experience for gaining knowledge and practical skills through interactive learning modules like video lessons and lab simulations." ,Cost:"R 3,726.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "HYBRID SERVICE PRO II:ADVANCED ", description: "Hybrid Server Pro: Advanced is a high-quality, easy-to-use curriculum where you will gain the advanced knowledge and skills you need to configure and manage both on-premise and cloud based servers. Hosted on the online TestOut learning platform, LabSim, it provides a comprehensive experience for gaining knowledge and practical skills through interactive learning modules like video lessons and lab simulations." ,Cost:"R 3,726.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CySA+", description: "CompTIA CertMaster Practice is an online knowledge assessment and training companion tool to help you prepare for your CompTIA certification exam. Featuring an adaptive question-first design, CertMaster Practice quickly assesses what you already know and what you still need to learn." ,Cost:"R 8,245.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "PENTEST+", description: "CompTIA CertMaster Practice for PenTest+ PT0-003 is your online training companion and knowledge assessment tool designed to help you become a certified penetration tester. In the ever-evolving cybersecurity landscape, staying ahead of threats is vital. This dynamic tool enhances your knowledge and pinpoints learning gaps, equipping you with the skills to identify vulnerabilities and safeguard organizations from cyber threats." ,Cost:"R 8,569.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CASP+", description: "CompTIA CertMaster Practice is an online knowledge assessment and training companion tool to help you prepare for your CompTIA certification exam. Featuring an adaptive question-first design, CertMaster Practice quickly assesses what you already know and what you still need to learn. " ,Cost:"R 3,223.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "SECURITY X", description: "CompTIA CertMaster Practice for SecurityX CAS-005 is an online knowledge assessment and training companion tool specifically designed to prepare you for the SecurityX certification exam. In the dynamic world of cybersecurity, staying ahead of attacks and ensuring your skills are current is essential.",Cost:"R 15,471.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CLOUD NET X", description: "CertMaster Perform brings together narrative instructional content, videos, performance-based questions (PBQs), skills assessments, live labs and more to offer a comprehensive learning experience to prepare candidates for their CompTIA certification exam and validate their expertise in cybersecurity" ,Cost:"R 15 471.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "DATA+", description: "CompTIA CertMaster Practice is an online knowledge assessment and training companion tool to help you prepare for your CompTIA certification exam. Featuring an adaptive question-first design, CertMaster Practice quickly assesses what you already know and what you still need to learn.",Cost:"R 5,653.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS" },
      { title: "PROJECT +", description: "CompTIA CertMaster Practice is an online knowledge assessment and training companion tool to help you prepare for your CompTIA certification exam. Featuring an adaptive question-first design, CertMaster Practice quickly assesses what you already know and what you still need to learn." ,Cost:"R 7,209.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "MICROSOFT EXCEL PRO", description: "TestOut Pro Certified: Microsoft Excel® is hosted on the online TestOut learning platform, LabSim. This provides a comprehensive experience for gaining knowledge and practical skills through interactive learning modules like video lessons and lab simulations that are accessible in one place." ,Cost:"R 563.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "AI ESSENTIALS", description: "CompTIA AI Essentials develops skills that enhance careers by providing competency in basic AI fundamentals, giving learners a competitive edge." ,Cost:"R 1,603.80",NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS" },
      { title: "CLOUD  ESSENTIALS +", description: "CompTIA Cloud Essentials develops skills that enhance careers by providing competency in how businesses function and operate and financial literacy." ,Cost:"R 3,223.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "SOFT SKILLS ESSENTIALS ", description: "CompTIA Soft Skills Essentials develops skills that enhance careers by providing competency in critical interpersonal, communication, and collaboration skills." ,Cost:"R 1,603.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CLOUD  ESSENTIALS", description: "CompTIA Cloud Essentials develops skills that enhance careers by providing competency in basic cloud concepts, giving learners a competitive edge." ,Cost:"R  1,603.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CYBER DEFENSE PRO", description: " Cyber Defense Pro is a comprehensive cybersecurity training program designed to equip individuals with the skills and knowledge needed to defend against cyber threats." ,Cost:"R  4,455.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "ETHICAL HACKER PRO", description: "training and certification programs designed to equip individuals with the skills and knowledge to identify and mitigate security vulnerabilities in systems and networks." ,Cost:"R  4,941.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "SECURITY PRO", description: "Responsible for safeguarding an organization's digital and physical assets from potential threats" ,Cost:"R  3,807.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "DATA SYS+", description: "DATASYS+ is a vendor-neutral, foundational data management certification offered by CompTIA" ,Cost:"R  8,910.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
       { title: "DATA X", description: "The premier certification for highly experienced professionals seeking to validate competency in the rapidly evolving field of data science." ,Cost:"R  14,742.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
       { title: "BUSINESS ESSSENTIALS", description: "Encompass the fundamental elements required for a business to operate effectively and achieve its goals." ,Cost:"R  1,603.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "IT FUNDAMENTALS PRO", description: "A certification and training program designed to introduce individuals to the core concepts and skills needed for a career in Information Technology." ,Cost:"R  1,701.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "MICROSOFT WORD PRO", description: "designed to enhance proficiency in advanced Microsoft Word skills and prepare individuals for the Microsoft Office Specialist (MOS) Word Associate-level certification." ,Cost:"R  1,603.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
       { title: "MICROSOFT OFFICE PRO", description: "A suite of applications that includes essential tools like Word, Excel, PowerPoint, and Outlook, along with Publisher and Access." ,Cost:"R   2,737.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
       { title: "PROJECT MANAGEMENT ESSENTIALS", description: "Project management is essential for ensuring projects are completed successfully, on time, and within budget." ,Cost:"R   1,603.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "A+ NETWORK", description: "CompTIA A+ is an entry-level IT certification that validates foundational knowledge and skills in hardware, networking, operating systems, and security." ,Cost:"R   8,083.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "CISCO NETWORKING PRO", description: "Cisco Networking Pro is a training program designed to equip individuals with foundational networking concepts and skills, particularly focused on Cisco routers and switches, and prepares them for the Cisco CCNA (200-301) certification." ,Cost:"R   3,969.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "WINDOWS CLIENT PRO", description: "a training course and certification focused on the skills needed to manage and support Windows operating systems in professional IT environments. " ,Cost:"R   3,726.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "LINUX PRO", description: "A training course and certification focused on the skills needed to manage and support Windows operating systems in professional IT environments. " ,Cost:"R   4,455.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "A + CORE 1 V15", description: "The first of two exams required to earn the A+ certification, specifically the updated version (v15). " ,Cost:"R   4,455.00" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "A + CORE 2 V15", description: "The second of two exams required to earn the CompTIA A+ certification, focusing on operating systems, security, software troubleshooting, and operational procedures. " ,Cost:"R   5,977.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
      { title: "A + CORE 1 & 2 V15", description: "CompTIA A+ Core 1 and Core 2 (V15) are the two exams required to earn the CompTIA A+ certification. " ,Cost:"R   5,977.80" ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
       { title: "PC PRO", description: "a training course and certification designed to equip individuals with the foundational knowledge and skills needed to excel in entry-level IT support roles, particularly in PC hardware and software troubleshooting." ,Cost:"R  3,726.00 " ,NB:"PLEASE NOTE TO USE MODULE NAME AS REFERENCE WHEN MAKING PAYMENTS"},
